...
export function App(){
    ...
    const simbolChanger = (number) => {
        setBoard(board.map((element)=>{
            if(element == turn) {return marks[number]}
            else{ return element}
        }))
    ...
    <main className="board">
        ...
        <div className="character-selector_container">
            <button onClick={activateModal}><img src={exit} alt="" /></button>
            <section className="character-selector">
            {
                marks.map((_,index) => {
                    return ((marks[index] != turnx && marks[index] != turno) && <Square key={index}>
                        <img 
        ...
        <section className="turn">
            <Square isSelected={turn == turnx}><img className="table_element" src={turnx} alt=""/></Square>
            <Square isSelected={turn == turno}><img className="table_element" src={turno} alt=""/></Square>
        </section>
